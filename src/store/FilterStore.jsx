...
const DEFAULT_NAME = 'Unnamed.filter'
// The default name is deliberately a nudge — "Unnamed.filter" prompts the user to name their
// work (imports always take the imported file's name). Filters still carrying an old default
// name ("Nolvus's Filter", "Exile Codex") follow along.
const migrateName = (n) => (!n || n === "Nolvus's Filter" || n === 'Exile Codex') ? DEFAULT_NAME : n
