...
// Item art is bundled locally under /public/img (opaque hashed filenames via assets.js).
...
export const PRESETS = [
  {
    ...
    img: asset('presets/presetEarlyCampaign1.webp'),
  ...
  },
  {
    ...
    img: asset('presets/interludes.webp'),
  ...
  },
  {
    ...
    img: asset('presets/presetProgressingMaps70.webp'),
  ...
  },
  {
    ...
    img: asset('presets/presetEarlyEndgame80.webp'),
  ...
  },
  {
    ...
    img: asset('presets/presetLateEndgame90.webp'),
  ...
  },
  {
    ...
    img: asset('presets/presetVeryStrict95.webp'),
...
export const CLASSES = [
  { id: 'warrior',   name: 'Warrior',   img: asset('presets/warrior.webp') },
  { id: 'mercenary', name: 'Mercenary', img: asset('presets/mercenary.webp') },
  { id: 'ranger',    name: 'Ranger',    img: asset('presets/ranger.webp') },
  { id: 'huntress',  name: 'Huntress',  img: asset('presets/huntress.webp') },
  { id: 'monk',      name: 'Monk',      img: asset('presets/monk.webp') },
  { id: 'witch',     name: 'Witch',     img: asset('presets/witch.webp') },
  { id: 'sorceress', name: 'Sorceress', img: asset('presets/sorceress.webp') },
  { id: 'druid',     name: 'Druid',     img: asset('presets/druid.webp') },
]
