...
export const CHANGELOG = [
  ...
  },
  {
    ...
    body: [
      "Six pages clone the poe2filter.com structure: Presets, Quick Filters, Tier Lists, Custom Rules, Cosmetic, Preview.",
  ...
  },
  {
    ...
    body: [
      "Replaced the old generic rule editor with the real poe2filter.com app shape.",
