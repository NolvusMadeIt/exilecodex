...
import { POE1_LEAGUE_ENDED, POE2_LEAGUE_ENDED, LEAGUE_ENDED_MESSAGE, LEAGUE_ENDED_TOOLTIP } from '../../shared/leagueStatus' /* XILE-PORT: path — our shared/ sits under src/xilehud/ */;
