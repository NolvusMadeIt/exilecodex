 ...
 * Upstream path: src/main/clipboard-monitor.ts (v0.6.11).
 * XILE-PORT: mechanical TypeScript→CommonJS translation (our Electron main is build-step-free
 * CJS) — types stripped, imports converted; logic, comments and behavior unchanged.
 */
