...
local function run_sim(done)
  local seq = {
    ...
    function() step("ExileCodex 2.1.6-alpha available", "update") end,
    function() progress(0, "Downloading ExileCodex 2.1.6-alpha") end,
    function() progress(38) end,
    function() progress(72) end,
    function() progress(100) end,
    function() progress(-1); step("✓ Downloaded ExileCodex 2.1.6-alpha", "ok") end,
