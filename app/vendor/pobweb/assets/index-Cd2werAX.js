...
class CanvasManager {
  constructor(config) {
    ...
    __publicField(this, "canvasContainer", null);
    __publicField(this, "root", null);
    __publicField(this, "currentStyleWidth");
    __publicField(this, "currentStyleHeight");
    __publicField(this, "isFixedSize", false);
    __publicField(this, "config");
    __publicField(this, "resizeObserver", null);
    __publicField(this, "_scale", 1);
    __publicField(this, "_panTranslateX", 0);
    __publicField(this, "_panTranslateY", 0);
    __publicField(this, "_zoomTranslateX", 0);
    __publicField(this, "_zoomTranslateY", 0);
    __publicField(this, "_minScale", 0.1);
    __publicField(this, "_maxScale", 2);
    __publicField(this, "_containerWidth", 800);
    __publicField(this, "_containerHeight", 600);
    __publicField(this, "_isInitialScale", true);
    __publicField(this, "_initialScale", 1);
    __publicField(this, "onStateChange");
    __publicField(this, "onRenderingSizeChange");
    this.config = config;
  ...
  getCurrentState() {
    var _a;
    const containerRect = (_a = this.canvasContainer) == null ? void 0 : _a.getBoundingClientRect();
    const containerSize = containerRect ? { width: containerRect.width, height: containerRect.height } : { width: 0, height: 0 };
    return {
  ...
  get transform() {
    return {
      scale: this._scale,
      translateX: this._panTranslateX + this._zoomTranslateX,
      // Combined translation for external use
  ...
  screenToCanvas(containerX, containerY) {
    ...
    const result = {
      x: (containerX - totalTranslateX) / this._scale,
      // Complete inverse of applied CSS transform
      y: (containerY - totalTranslateY) / this._scale
      // Both pan and zoom translation considered
    };
    return result;
  }
  ...
  calculateStyleSize(containerWidth, containerHeight) {
    if (this.isFixedSize) {
      return {
  ...
  notifyStateChange(containerWidth, containerHeight) {
...
const PoBKeyboardState = {
  make(callbacks) {
    const keys = /* @__PURE__ */ new Set();
    return {
      pobKeys: keys,
      keydown(pobKey, doubleclick) {
        if (doubleclick < 1) {
          keys.add(pobKey);
        }
        callbacks == null ? void 0 : callbacks.onKeyDown(this, pobKey, doubleclick);
      },
      keyup(pobKey) {
        keys.delete(pobKey);
        callbacks == null ? void 0 : callbacks.onKeyUp(this, pobKey);
      },
      keypress(char) {
        callbacks == null ? void 0 : callbacks.onChar(this, char);
      }
    };
  }
};
const DOMKeyboardState = {
  make(pobKeyboardState) {
    ...
    return {
      keydown(domKey) {
        ...
        if (char) {
          pobKeyboardState == null ? void 0 : pobKeyboardState.keypress(char);
        }
      },
      keyup(domKey) {
      ...
      virtualKeyPress(domKey, isModifier) {
        if (isModifier) {
          ...
          this.keydown(domKey);
          if (domKey.length === 1) {
            const char = heldKeys.has("Shift") ? applyShiftTransformation(domKey) : domKey;
            this.keypress(char);
          }
          this.keyup(domKey);
        }
...
const DOM_TO_POB_KEY_MAP = /* @__PURE__ */ new Map([
  ["Backspace", "BACK"],
  ["Tab", "TAB"],
  ["Enter", "RETURN"],
  ["Escape", "ESCAPE"],
...
const EXTRA_CHAR_MAP = /* @__PURE__ */ new Map([
  ["Backspace", "\b"],
  ["Tab", "	"],
  ["Enter", "\r"],
  ["Escape", "\x1B"]
]);
function domKeyToPobKey(domKey) {
...
const SHIFT_MAP = /* @__PURE__ */ new Map([
  ["1", "!"],
  ["2", "@"],
  ["3", "#"],
  ["4", "$"],
...
function applyShiftTransformation(domKey) {
  if (/^[a-z]$/.test(domKey)) {
...
const MOUSE_BUTTONS = ["LEFTBUTTON", "MIDDLEBUTTON", "RIGHTBUTTON", "MOUSE4", "MOUSE5"];
function mouseString(e) {
  return MOUSE_BUTTONS[e.button];
}
const _MouseHandler = class _MouseHandler {
  constructor(el, callbacks, pobKeyboardState) {
    __publicField(this, "_cursorPosition", { x: 0, y: 0 });
    __publicField(this, "_panModeEnabled", false);
    __publicField(this, "_isMousePanning", false);
    __publicField(this, "_mouseStartPos", null);
    __publicField(this, "_touches", /* @__PURE__ */ new Map());
    __publicField(this, "_longPressTimer", null);
    __publicField(this, "_lastTapTime", 0);
    __publicField(this, "_twoFingerDistance", 0);
    __publicField(this, "_twoFingerCenter", { x: 0, y: 0 });
    __publicField(this, "_isZooming", false);
    __publicField(this, "_isPanning", false);
    __publicField(this, "_isPanModeActive", false);
    __publicField(this, "_threeFingerPanning", false);
    __publicField(this, "_threeFingerCenter", { x: 0, y: 0 });
    __publicField(this, "_multiTouchPreventionTimer", null);
    __publicField(this, "_allowMouseUpdates", true);
    __publicField(this, "_isTouchLeftButtonDown", false);
    __publicField(this, "_wheelAccumulator", 0);
    this.el = el;
    this.callbacks = callbacks;
    this.pobKeyboardState = pobKeyboardState;
  ...
  updateMouseState(pos) {
    ...
    if (this._allowMouseUpdates) {
      (_b = (_a = this.callbacks).onMouseStateUpdate) == null ? void 0 : _b.call(_a, this.mouseState);
    }
  }
  setPanMode(enabled) {
  ...
  handleMouseMove(e) {
    ...
    if (this._panModeEnabled && this._isMousePanning && this._mouseStartPos) {
      ...
      if (deltaX !== 0 || deltaY !== 0) {
        (_b = (_a = this.callbacks).onPan) == null ? void 0 : _b.call(_a, deltaX, deltaY);
    ...
    if (e.touches.length === 1) {
      ...
      if (!this._panModeEnabled) {
        ...
        this._longPressTimer = window.setTimeout(() => {
          this.pobKeyboardState.keydown("RIGHTBUTTON", 0);
          this.pobKeyboardState.keyup("RIGHTBUTTON");
    ...
    if (e.touches.length === 1) {
          ...
          if (!this._isPanModeActive && this._longPressTimer) {
            ...
            if (touchData) {
              ...
              if (distance > 5) {
                ...
                this.pobKeyboardState.keydown("LEFTBUTTON", 0);
      ...
      if (!this._threeFingerPanning) {
        ...
        if (this._isZooming && !this._isPanning) {
          ...
          (_b = (_a = this.callbacks).onZoom) == null ? void 0 : _b.call(_a, scale, this._twoFingerCenter.x, this._twoFingerCenter.y);
          ...
          if (Math.abs(centerDelta.y) > Math.abs(centerDelta.x)) {
            ...
            if (Math.abs(this._wheelAccumulator) >= _MouseHandler.WHEEL_SENSITIVITY) {
      ...
      if (this._threeFingerPanning) {
        (_d = (_c = this.callbacks).onPan) == null ? void 0 : _d.call(_c, centerDelta.x, centerDelta.y);
      }
      ...
      if (!this._panModeEnabled) {
        if (this._isPanModeActive) {
          ...
          if (this._isTouchLeftButtonDown) {
            this.pobKeyboardState.keyup("LEFTBUTTON");
...
__publicField(_MouseHandler, "WHEEL_SENSITIVITY", 4);
let MouseHandler = _MouseHandler;
...
const PerformanceOverlay = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:absolute pw:top-2 pw:right-2 pw:bg-base-100/90 pw:p-3 pw:rounded pw:backdrop-blur-sm pw:space-y-2 pw:max-w-80 pw:pointer-events-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LineChart, { data: frames }),
    renderStats && /* @__PURE__ */ jsxRuntimeExports.jsx(RenderStatsView, { stats: renderStats, onLayerVisibilityChange })
  ] });
};
function LineChart({ data }) {
    ...
    return {
      svg: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Render performance" }),
            series.map((line, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: line.x1 * scaleX,
                y1: line.y1 * scaleY,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:relative pw:w-64 pw:h-16", children: [
    chart.svg,
    Number.isFinite(chart.max) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pw:absolute pw:bottom-1 pw:left-1 pw:p-1 pw:text-xs pw:bg-neutral pw:text-neutral-content pw:rounded", children: [
      "Max ",
      chart.max.toFixed(1),
      "ms Avg ",
      chart.avg.toFixed(1),
...
function RenderStatsView({
  ...
  const [showLayers, setShowLayers] = reactExports.useState(false);
  const [layerVisibility, setLayerVisibility] = reactExports.useState(/* @__PURE__ */ new Map());
  if (!stats) {
    return null;
  }
  const summary = {
  ...
  const toggleLayerVisibility = reactExports.useCallback(
    (layer, sublayer) => {
      ...
      onLayerVisibilityChange == null ? void 0 : onLayerVisibilityChange(layer, sublayer, newVisibility);
    },
    [layerVisibility, onLayerVisibilityChange]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:text-xs pw:space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:font-semibold", children: [
      "Render Stats (Frame #",
      summary.frameCount,
      ")"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:grid pw:grid-cols-2 pw:gap-1 pw:text-xs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "Images: ",
        summary.totalDrawImage
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "Quads: ",
        summary.totalDrawImageQuad
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "Text: ",
        summary.totalDrawString
      ] })
    ] }),
    layerDetails.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:space-y-1", children: [
      ...
      showLayers && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pw:max-h-24 pw:overflow-y-auto pw:space-y-0.5", children: layerDetails.map((layer) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:text-xs pw:font-mono pw:flex pw:items-center pw:gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => toggleLayerVisibility(layer.layer, layer.sublayer),
              className: `pw:w-3 pw:h-3 pw:text-xs pw:border pw:rounded ${isVisible ? "pw:bg-green-500 pw:text-white" : "pw:bg-red-500 pw:text-white"}`,
              children: isVisible ? "●" : "○"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: isVisible ? "" : "pw:opacity-50", children: [
            "L",
            layer.layer,
            ".",
            layer.sublayer,
            ...
            layerTotal,
            "d (I",
            layer.drawImageCount,
            " Q",
            layer.drawImageQuadCount,
            " T",
            layer.drawStringCount,
            ")"
          ] })
        ] }, layerKey);
      }) })
...
const KeyButton = ({ label, char, width, callbacks, isActive = false }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: `${baseClasses} ${variantClasses}`, style: { width }, onClick: executeAction, children: label === "Space" ? "␣" : label });
};
const VirtualKeyboard = ({ isVisible, keyboardState }) => {
  const [heldKeys, setHeldKeys] = reactExports.useState(/* @__PURE__ */ new Set());
  const [symbolMode, setSymbolMode] = reactExports.useState(false);
  ...
  const calculateInitialPosition = reactExports.useCallback(() => {
  ...
  const constrainPositionToViewport = reactExports.useCallback((pos) => {
  ...
  const getInitialPosition = reactExports.useCallback(() => {
  ...
  const letterKeyLayout = reactExports.useMemo(
    () => [
      [
        { event: "1", display: "1" },
        { event: "2", display: "2" },
  ...
  const symbolKeyLayout = reactExports.useMemo(
    () => [
      [
        { event: "!", display: "!" },
        { event: "@", display: "@" },
  ...
  const handleKeyPress = reactExports.useCallback(
    (eventKey, keyDef) => {
      ...
      const newHeldKeys = keyboardState.virtualKeyPress(eventKey, isModifier);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pw:bg-base-200/80 pw:rounded pw:relative pw:pointer-events-auto pw:px-0.5 pw:pt-6 pw:pb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "", children: keyLayout.map((row, rowIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: row.map((keyDef) => {
              ...
              const isActive = isModifier && heldKeys.has(event) || event === "SymbolMode" && symbolMode || event === "LetterMode" && !symbolMode;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                KeyButton,
                {
                  label: display,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(MdDragIndicator, { size: 16 })
          }
        )
      ] })
    }
...
const OverlayContainer = ({
  ...
  const [panModeEnabled, setPanModeEnabled] = reactExports.useState(externalPanMode ?? false);
  const [keyboardVisible, setKeyboardVisible] = reactExports.useState(false);
  const [performanceOverlayVisible, setPerformanceOverlayVisible] = reactExports.useState(performanceVisible);
  reactExports.useEffect(() => {
    setPerformanceOverlayVisible(performanceVisible);
  }, [performanceVisible]);
  reactExports.useEffect(() => {
    if (externalPanMode !== void 0) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(VirtualKeyboard, { isVisible: keyboardVisible, keyboardState }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          PerformanceOverlay,
          {
...
class ReactOverlayManager {
  constructor(container) {
    ...
    __publicField(this, "currentProps", null);
  ...
  render(props) {
    ...
    if (this.root) {
      this.root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(OverlayContainer, { ...props }));
    }
  }
  updateState(updates) {
    if (this.currentProps && this.root) {
      ...
      this.root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(OverlayContainer, { ...newProps }));
    }
  }
  destroy() {
    if (this.root) {
...
function WorkerWrapper(options) {
  return new Worker(
    "" + new URL("worker-BhJdjD0P.js", import.meta.url).href,
    {
      type: "module",
...
class Driver {
  // toolbar removed for the ExileCodex desktop overlay — no reserved strip
  constructor(build, assetPrefix, hostCallbacks) {
    __publicField(this, "isStarted", false);
    __publicField(this, "eventHandler");
    __publicField(this, "mouseHandler");
    __publicField(this, "pobKeyboardState");
    __publicField(this, "domKeyboardState");
    __publicField(this, "keyboardHandler");
    __publicField(this, "root");
    __publicField(this, "worker");
    __publicField(this, "driverWorker");
    __publicField(this, "overlayManager");
    __publicField(this, "canvasManager");
    __publicField(this, "panModeEnabled", false);
    __publicField(this, "orientationChangeHandler");
    __publicField(this, "windowResizeHandler");
    __publicField(this, "isHandlingLayoutChange", false);
    __publicField(this, "performanceVisible", false);
    __publicField(this, "frames", []);
    __publicField(this, "renderStats", null);
    __publicField(this, "externalComponent");
    __publicField(this, "MIN_CANVAS_WIDTH", 1550);
    __publicField(this, "MIN_CANVAS_HEIGHT", 800);
    __publicField(this, "TOOLBAR_SIZE", 0);
    this.build = build;
    this.assetPrefix = assetPrefix;
    this.hostCallbacks = hostCallbacks;
    const originalOnFrame = this.hostCallbacks.onFrame;
    this.hostCallbacks.onFrame = (at, time, stats) => {
      this.pushFrame(at, time, stats);
      originalOnFrame(at, time, stats);
    };
  }
  async start(fileSystemConfig) {
    if (this.isStarted) throw new Error("Already started");
    this.isStarted = true;
    this.worker = new WorkerWrapper();
    this.driverWorker = wrap(this.worker);
    return this.driverWorker.start(
      this.build,
      this.assetPrefix,
      fileSystemConfig,
      proxy(this.hostCallbacks.onError),
      proxy(this.hostCallbacks.onFrame),
      proxy(this.hostCallbacks.onFetch),
      proxy(this.hostCallbacks.onTitleChange),
      proxy((text) => this.copy(text)),
      proxy(() => this.paste()),
      proxy((url) => {
  ...
  destory() {
    var _a, _b;
    (_a = this.driverWorker) == null ? void 0 : _a.destroy();
    (_b = this.worker) == null ? void 0 : _b.terminate();
  }
  attachToDOM(root, useWebGPU = false) {
    var _a, _b, _c;
    ...
    this.canvasManager.setCallbacks({
      onStateChange: (state) => {
        var _a2;
        (_a2 = this.overlayManager) == null ? void 0 : _a2.updateState({
          currentCanvasSize: state.styleSize,
          isFixedSize: state.isFixedSize
        });
      },
      onRenderingSizeChange: (renderingSize) => {
        var _a2;
        (_a2 = this.driverWorker) == null ? void 0 : _a2.resize({
    ...
    (_a = this.driverWorker) == null ? void 0 : _a.setCanvas(transfer(offscreenCanvas, [offscreenCanvas]), useWebGPU);
    ...
    this.pobKeyboardState = PoBKeyboardState.make({
      onKeyDown: (state, key, doubleClick) => {
        var _a2, _b2, _c2;
        (_a2 = this.driverWorker) == null ? void 0 : _a2.updateKeyboardState(state.pobKeys);
        (_b2 = this.driverWorker) == null ? void 0 : _b2.handleKeyDown(key, doubleClick);
        if (doubleClick > 0) (_c2 = this.driverWorker) == null ? void 0 : _c2.handleKeyUp(key, 0);
      },
      onKeyUp: (state, key) => {
        var _a2, _b2;
        (_a2 = this.driverWorker) == null ? void 0 : _a2.updateKeyboardState(state.pobKeys);
        (_b2 = this.driverWorker) == null ? void 0 : _b2.handleKeyUp(key, 0);
      },
      onChar: (state, key) => {
        var _a2, _b2;
        (_a2 = this.driverWorker) == null ? void 0 : _a2.updateKeyboardState(state.pobKeys);
        (_b2 = this.driverWorker) == null ? void 0 : _b2.handleChar(key, 0);
      }
    });
    ...
    this.mouseHandler = new MouseHandler(
      container,
      {
        onMouseMove: () => {
          ...
          (_a2 = this.driverWorker) == null ? void 0 : _a2.handleMouseMove(transformedMouse);
        },
        ...
        onZoom: (scale, centerX, centerY) => {
          var _a2;
          (_a2 = this.canvasManager) == null ? void 0 : _a2.zoom(scale, centerX, centerY);
          this.updateOverlayWithTransform();
        },
        onPan: (deltaX, deltaY) => {
          var _a2;
          (_a2 = this.canvasManager) == null ? void 0 : _a2.pan(deltaX, deltaY);
          this.updateOverlayWithTransform();
        }
      },
    ...
    this.eventHandler = new EventHandler(container, {
      onVisibilityChange: (visible) => {
        var _a2;
        return (_a2 = this.driverWorker) == null ? void 0 : _a2.handleVisibilityChange(visible);
      }
    });
    this.mouseHandler.setPanMode(this.panModeEnabled);
    (_b = this.driverWorker) == null ? void 0 : _b.handleVisibilityChange(root.ownerDocument.visibilityState === "visible");
    const toolbarCallbacks = {
      onZoomReset: () => {
        var _a2;
        (_a2 = this.canvasManager) == null ? void 0 : _a2.resetZoom();
        this.updateOverlayWithTransform();
      },
      onZoomChange: (zoom) => {
        this.zoomTo(zoom);
      ...
      onCanvasSizeChange: (width, height) => {
        var _a2;
        (_a2 = this.canvasManager) == null ? void 0 : _a2.setCanvasStyleSize(width, height);
      },
      onFixedSizeToggle: (isFixed) => {
        var _a2, _b2, _c2;
        if (isFixed) {
          const currentSize = (_a2 = this.canvasManager) == null ? void 0 : _a2.getStyleSize();
          if (currentSize) {
            (_b2 = this.canvasManager) == null ? void 0 : _b2.setCanvasStyleSize(currentSize.width, currentSize.height);
          }
        } else {
          (_c2 = this.canvasManager) == null ? void 0 : _c2.resetToAutoSize();
        }
        this.updateOverlayWithTransform();
      },
      onLayoutChange: () => {
    ...
    this.overlayManager.render({
      ...
      currentZoom: ((_c = this.canvasManager) == null ? void 0 : _c.transform.scale) ?? 1,
      ...
      onLayerVisibilityChange: (layer, sublayer, visible) => {
  ...
  detachFromDOM() {
    var _a, _b, _c, _d, _e;
    (_a = this.canvasManager) == null ? void 0 : _a.detachFromDOM();
    (_b = this.overlayManager) == null ? void 0 : _b.destroy();
    ...
    (_c = this.eventHandler) == null ? void 0 : _c.destroy();
    (_d = this.mouseHandler) == null ? void 0 : _d.destroy();
    (_e = this.keyboardHandler) == null ? void 0 : _e.destroy();
  ...
  async loadBuildFromCode(code) {
    var _a;
    return (_a = this.driverWorker) == null ? void 0 : _a.loadBuildFromCode(code);
  }
  setLayerVisible(layer, sublayer, visible) {
    var _a;
    return (_a = this.driverWorker) == null ? void 0 : _a.setLayerVisible(layer, sublayer, visible);
  }
  pushFrame(at, renderTime, stats) {
    this.frames = [...this.frames, { at, renderTime }].slice(-60);
    if (stats) {
  ...
  setExternalToolbarComponent(component) {
    this.externalComponent = component;
    this.updateOverlayWithTransform();
  }
  transformMouseCoordinates(mouseState) {
  ...
  updateOverlayWithTransform() {
    var _a;
    if (!this.canvasManager) {
      return;
    }
    const canvasState = this.canvasManager.getCurrentState();
    (_a = this.overlayManager) == null ? void 0 : _a.updateState({
  ...
  resetTransform() {
    var _a;
    (_a = this.canvasManager) == null ? void 0 : _a.resetTransform();
    this.updateOverlayWithTransform();
  }
  zoomTo(scale, centerX, centerY) {
  ...
  setCanvasSize(width, height) {
    var _a, _b;
    (_a = this.canvasManager) == null ? void 0 : _a.setCanvasStyleSize(width, height);
    (_b = this.canvasManager) == null ? void 0 : _b.resetTransform();
    this.updateOverlayWithTransform();
  }
  adjustCanvasForOverlay() {
    if (!this.canvasManager) {
      return;
    }
    const windowWidth = window.innerWidth;
  ...
  setupOrientationAndResizeHandlers() {
  ...
  cleanupOrientationAndResizeHandlers() {
    if (this.orientationChangeHandler) {
      window.removeEventListener("orientationchange", this.orientationChangeHandler);
      this.orientationChangeHandler = void 0;
    }
  ...
  handleLayoutChange() {
    ...
    requestAnimationFrame(() => {
      var _a;
      this.adjustCanvasForOverlay();
      (_a = this.canvasManager) == null ? void 0 : _a.recalculateInitialScale();
      this.updateOverlayWithTransform();
...
(async () => {
  const ASSET_PREFIX = "https://asset.pob.cool".startsWith("/@fs") ? "https://asset.pob.cool" : new URL("game-assets", document.baseURI).href;
  const versionPrefix = `${ASSET_PREFIX}/games/${"poe2"}/versions/${"v0.8.0"}`;
  console.log("Loading driver with assets:", versionPrefix);
  const driver = new Driver("release", versionPrefix, {
    onError: (error) => console.error("[ec-boot] driver onError:", error),
  ...
  try {
    await driver.start({
      userDirectory: gameData["poe2"].userDirectory,
      cloudflareKvPrefix: "/api/kv/",
      cloudflareKvAccessToken: void 0,
      cloudflareKvUserNamespace: void 0
    });
    const el = document.querySelector("#window");
    if (el) driver.attachToDOM(el);
  } catch (e) {
    console.error("PoB driver failed to start:", e);
  }
})();
//# sourceMappingURL=index-Cd2werAX.js.map
